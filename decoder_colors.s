...
interpretALine:
	...
	sub0:
		...
		jmp		loop2					# skip text and background colour change and jump to printing the character
...
decode:
	...
	loop:
		...
		pushq	%r15					# save r15 content since we use the register in the interpretALine subroutine
		subq	$8, %rsp				# move rsp to keep the stack aligned (8 bytes)
		call	interpretALine			# call interpretALine
		addq	$8, %rsp				# move rsp to keep the stack aligned (8 bytes)
		popq	%r15					# return r15 it's content
